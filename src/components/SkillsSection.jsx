...
const SECTIONS = [
  {
    ...
    summary:
      "Building fast, responsive, and user-centric web applications with modern frameworks, reusable components, and engaging user experiences.",
    stack: [
      "React.js",
      "Next.js",
      "TypeScript",
  ...
  },
  {
    ...
    summary:
      "Building secure, scalable server-side applications with authentication, REST APIs, and real-time communication.",
    stack: [
      "Node.js",
      "Express.js",
      "REST APIs",
  ...
  },
  {
    ...
    summary:
      "Designing efficient database schemas, managing data models, and optimizing database operations for scalable applications.",
    stack: [
      "MongoDB",
      "Mongoose",
      "MongoDB Atlas",
    ...
    color: "#16A34A",
    glow: "rgba(22,163,74,",
    bg: "radial-gradient(circle at center, rgba(22,163,74,0.12) 0%, rgba(0,0,0,0) 70%)",
  ...
  },
  {
    ...
    summary:
      "Using modern tools and cloud platforms to build, deploy, and maintain production-ready applications efficiently.",
    stack: [
      "Git",
      "GitHub",
      "VS Code",
